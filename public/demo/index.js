(function (three,dat,Stats) {
	...
	var OctreeHelper = (function (Object3D$$1) {
		...
		if ( Object3D$$1 ) OctreeHelper.__proto__ = Object3D$$1;
		OctreeHelper.prototype = Object.create( Object3D$$1 && Object3D$$1.prototype );
	...
	Vector3$1.prototype.set = function set (x, y, z) {
	...
	Vector3$1.prototype.copy = function copy (v) {
	...
	Vector3$1.prototype.clone = function clone () {
	...
	Vector3$1.prototype.fromArray = function fromArray (array, offset) {
	...
	Vector3$1.prototype.toArray = function toArray (array, offset) {
	...
	Vector3$1.prototype.setFromSpherical = function setFromSpherical (s) {
	...
	Vector3$1.prototype.setFromCylindrical = function setFromCylindrical (c) {
	...
	Vector3$1.prototype.setFromMatrixColumn = function setFromMatrixColumn (m, index) {
	...
	Vector3$1.prototype.setFromMatrixPosition = function setFromMatrixPosition (m) {
	...
	Vector3$1.prototype.setFromMatrixScale = function setFromMatrixScale (m) {
	...
	Vector3$1.prototype.add = function add (v) {
	...
	Vector3$1.prototype.addScalar = function addScalar (s) {
	...
	Vector3$1.prototype.addVectors = function addVectors (a, b) {
	...
	Vector3$1.prototype.addScaledVector = function addScaledVector (v, s) {
	...
	Vector3$1.prototype.sub = function sub (v) {
	...
	Vector3$1.prototype.subScalar = function subScalar (s) {
	...
	Vector3$1.prototype.subVectors = function subVectors (a, b) {
	...
	Vector3$1.prototype.multiply = function multiply (v) {
	...
	Vector3$1.prototype.multiplyScalar = function multiplyScalar (s) {
	...
	Vector3$1.prototype.multiplyVectors = function multiplyVectors (a, b) {
	...
	Vector3$1.prototype.divide = function divide (v) {
	...
	Vector3$1.prototype.divideScalar = function divideScalar (s) {
	...
	Vector3$1.prototype.cross = function cross (v) {
	...
	Vector3$1.prototype.crossVectors = function crossVectors (a, b) {
	...
	Vector3$1.prototype.applyMatrix3 = function applyMatrix3 (m) {
	...
	Vector3$1.prototype.applyMatrix4 = function applyMatrix4 (m) {
	...
	Vector3$1.prototype.applyQuaternion = function applyQuaternion (q) {
	...
	Vector3$1.prototype.negate = function negate () {
	...
	Vector3$1.prototype.dot = function dot (v) {
	...
	Vector3$1.prototype.reflect = function reflect (n, target) {
			if ( target === void 0 ) target = new Vector3$1();
	...
	Vector3$1.prototype.angleTo = function angleTo (v) {
	...
	Vector3$1.prototype.lengthManhattan = function lengthManhattan () {
	...
	Vector3$1.prototype.lengthSquared = function lengthSquared () {
	...
	Vector3$1.prototype.length = function length () {
	...
	Vector3$1.prototype.distanceToManhattan = function distanceToManhattan (v) {
	...
	Vector3$1.prototype.distanceToSquared = function distanceToSquared (v) {
	...
	Vector3$1.prototype.distanceTo = function distanceTo (v) {
	...
	Vector3$1.prototype.normalize = function normalize () {
	...
	Vector3$1.prototype.setLength = function setLength (length) {
	...
	Vector3$1.prototype.min = function min (v) {
	...
	Vector3$1.prototype.max = function max (v) {
	...
	Vector3$1.prototype.clamp = function clamp (min, max) {
	...
	Vector3$1.prototype.floor = function floor () {
	...
	Vector3$1.prototype.ceil = function ceil () {
	...
	Vector3$1.prototype.round = function round () {
	...
	Vector3$1.prototype.lerp = function lerp (v, alpha) {
	...
	Vector3$1.prototype.lerpVectors = function lerpVectors (v1, v2, alpha) {
	...
	Vector3$1.prototype.equals = function equals (v) {
	...
	var Box3$1 = function Box3$$1(
		min,
		max
	) {
		if ( min === void 0 ) min = new Vector3$1(Infinity, Infinity, Infinity);
		if ( max === void 0 ) max = new Vector3$1(-Infinity, -Infinity, -Infinity);
	...
	Box3$1.prototype.set = function set (min, max) {
	...
	Box3$1.prototype.copy = function copy (b) {
	...
	Box3$1.prototype.clone = function clone () {
	...
	Box3$1.prototype.makeEmpty = function makeEmpty () {
	...
	Box3$1.prototype.getCenter = function getCenter (target) {
			if ( target === void 0 ) target = new Vector3$1();
	...
	Box3$1.prototype.getSize = function getSize (target) {
			if ( target === void 0 ) target = new Vector3$1();
	...
	Box3$1.prototype.getBoundingSphere = function getBoundingSphere (target) {
	...
	Box3$1.prototype.expandByPoint = function expandByPoint (p) {
	...
	Box3$1.prototype.expandByVector = function expandByVector (v) {
	...
	Box3$1.prototype.expandByScalar = function expandByScalar (s) {
	...
	Box3$1.prototype.setFromPoints = function setFromPoints (points) {
			var this$1 = this;
	...
	Box3$1.prototype.setFromCenterAndSize = function setFromCenterAndSize (center, size) {
	...
	Box3$1.prototype.clampPoint = function clampPoint (point, target) {
			if ( target === void 0 ) target = new Vector3$1();
	...
	Box3$1.prototype.distanceToPoint = function distanceToPoint (p) {
	...
	Box3$1.prototype.translate = function translate (offset) {
	...
	Box3$1.prototype.intersect = function intersect (b) {
	...
	Box3$1.prototype.union = function union (b) {
	...
	Box3$1.prototype.containsPoint = function containsPoint (p) {
	...
	Box3$1.prototype.containsBox = function containsBox (b) {
	...
	Box3$1.prototype.intersectsBox = function intersectsBox (b) {
	...
	Box3$1.prototype.intersectsSphere = function intersectsSphere (s) {
	...
	Box3$1.prototype.intersectsPlane = function intersectsPlane (p) {
	...
	Box3$1.prototype.equals = function equals (b) {
	...
	var Sphere = function Sphere(center, radius) {
		if ( center === void 0 ) center = new Vector3$1();
	...
	Sphere.prototype.getBoundingBox = function getBoundingBox (target) {
			if ( target === void 0 ) target = new Box3$1();
	...
	var Vector2$1 = function Vector2$$1(x, y) {
		if ( x === void 0 ) x = 0;
		if ( y === void 0 ) y = 0;
	...
	Vector2$1.prototype.set = function set (x, y) {
	...
	Vector2$1.prototype.copy = function copy (v) {
	...
	Vector2$1.prototype.clone = function clone () {
	...
	Vector2$1.prototype.fromArray = function fromArray (array, offset) {
			if ( offset === void 0 ) offset = 0;
	...
	Vector2$1.prototype.toArray = function toArray (array, offset) {
			if ( array === void 0 ) array = [];
			if ( offset === void 0 ) offset = 0;
	...
	Vector2$1.prototype.add = function add (v) {
	...
	Vector2$1.prototype.addScalar = function addScalar (s) {
	...
	Vector2$1.prototype.addVectors = function addVectors (a, b) {
	...
	Vector2$1.prototype.addScaledVector = function addScaledVector (v, s) {
	...
	Vector2$1.prototype.sub = function sub (v) {
	...
	Vector2$1.prototype.subScalar = function subScalar (s) {
	...
	Vector2$1.prototype.subVectors = function subVectors (a, b) {
	...
	Vector2$1.prototype.multiply = function multiply (v) {
	...
	Vector2$1.prototype.multiplyScalar = function multiplyScalar (s) {
	...
	Vector2$1.prototype.divide = function divide (v) {
	...
	Vector2$1.prototype.divideScalar = function divideScalar (s) {
	...
	Vector2$1.prototype.applyMatrix3 = function applyMatrix3 (m) {
	...
	Vector2$1.prototype.dot = function dot (v) {
	...
	Vector2$1.prototype.lengthManhattan = function lengthManhattan () {
	...
	Vector2$1.prototype.lengthSquared = function lengthSquared () {
	...
	Vector2$1.prototype.length = function length () {
	...
	Vector2$1.prototype.distanceToManhattan = function distanceToManhattan (v) {
	...
	Vector2$1.prototype.distanceToSquared = function distanceToSquared (v) {
	...
	Vector2$1.prototype.distanceTo = function distanceTo (v) {
	...
	Vector2$1.prototype.normalize = function normalize () {
	...
	Vector2$1.prototype.setLength = function setLength (length) {
	...
	Vector2$1.prototype.min = function min (v) {
	...
	Vector2$1.prototype.max = function max (v) {
	...
	Vector2$1.prototype.clamp = function clamp (min, max) {
	...
	Vector2$1.prototype.floor = function floor () {
	...
	Vector2$1.prototype.ceil = function ceil () {
	...
	Vector2$1.prototype.round = function round () {
	...
	Vector2$1.prototype.negate = function negate () {
	...
	Vector2$1.prototype.angle = function angle () {
	...
	Vector2$1.prototype.lerp = function lerp (v, alpha) {
	...
	Vector2$1.prototype.lerpVectors = function lerpVectors (v1, v2, alpha) {
	...
	Vector2$1.prototype.rotateAround = function rotateAround (center, angle) {
	...
	Vector2$1.prototype.equals = function equals (v) {

		return (v.x === this.x && v.y === this.y);

	};

	Object.defineProperties( Vector2$1.prototype, prototypeAccessors$1 );
	...
	var Box2 = function Box2(
		...
		if ( min === void 0 ) min = new Vector2$1(Infinity, Infinity);
		if ( max === void 0 ) max = new Vector2$1(-Infinity, -Infinity);
	...
	Box2.prototype.getCenter = function getCenter (target) {
			if ( target === void 0 ) target = new Vector2$1();
	...
	Euler.prototype.toVector3 = function toVector3 (vector) {
			if ( vector === void 0 ) vector = new Vector3$1();
	...
	var Line3 = function Line3(start, end) {
		if ( start === void 0 ) start = new Vector3$1();
		if ( end === void 0 ) end = new Vector3$1();
	...
	var Matrix4$1 = function Matrix4$$1() {
	...
	Matrix4$1.prototype.set = function set (n00, n01, n02, n03, n10, n11, n12, n13, n20, n21, n22, n23, n30, n31, n32, n33) {
	...
	Matrix4$1.prototype.identity = function identity () {
	...
	Matrix4$1.prototype.copy = function copy (matrix) {
	...
	Matrix4$1.prototype.clone = function clone () {
	...
	Matrix4$1.prototype.fromArray = function fromArray (array, offset) {
			if ( offset === void 0 ) offset = 0;
	...
	Matrix4$1.prototype.toArray = function toArray (array, offset) {
			if ( array === void 0 ) array = [];
			if ( offset === void 0 ) offset = 0;
	...
	Matrix4$1.prototype.getMaxScaleOnAxis = function getMaxScaleOnAxis () {
	...
	Matrix4$1.prototype.copyPosition = function copyPosition (matrix) {
	...
	Matrix4$1.prototype.setPosition = function setPosition (p) {
	...
	Matrix4$1.prototype.extractBasis = function extractBasis (xAxis, yAxis, zAxis) {
	...
	Matrix4$1.prototype.makeBasis = function makeBasis (xAxis, yAxis, zAxis) {
	...
	Matrix4$1.prototype.extractRotation = function extractRotation (m) {
	...
	Matrix4$1.prototype.makeRotationFromEuler = function makeRotationFromEuler (euler) {
	...
	Matrix4$1.prototype.makeRotationFromQuaternion = function makeRotationFromQuaternion (q) {
	...
	Matrix4$1.prototype.lookAt = function lookAt (eye, target, up) {
	...
	Matrix4$1.prototype.multiplyMatrices = function multiplyMatrices (a, b) {
	...
	Matrix4$1.prototype.multiply = function multiply (m) {
	...
	Matrix4$1.prototype.premultiply = function premultiply (m) {
	...
	Matrix4$1.prototype.multiplyScalar = function multiplyScalar (s) {
	...
	Matrix4$1.prototype.determinant = function determinant () {
	...
	Matrix4$1.prototype.getInverse = function getInverse (matrix) {
	...
	Matrix4$1.prototype.transpose = function transpose () {
	...
	Matrix4$1.prototype.scale = function scale (sx, sy, sz) {
	...
	Matrix4$1.prototype.makeScale = function makeScale (x, y, z) {
	...
	Matrix4$1.prototype.makeTranslation = function makeTranslation (x, y, z) {
	...
	Matrix4$1.prototype.makeRotationX = function makeRotationX (theta) {
	...
	Matrix4$1.prototype.makeRotationY = function makeRotationY (theta) {
	...
	Matrix4$1.prototype.makeRotationZ = function makeRotationZ (theta) {
	...
	Matrix4$1.prototype.makeRotationAxis = function makeRotationAxis (axis, angle) {
	...
	Matrix4$1.prototype.makeShear = function makeShear (x, y, z) {
	...
	Matrix4$1.prototype.compose = function compose (position, quaternion, scale) {
	...
	Matrix4$1.prototype.decompose = function decompose (position, quaternion, scale) {
	...
	Matrix4$1.prototype.makePerspective = function makePerspective (left, right, top, bottom, near, far) {
	...
	Matrix4$1.prototype.makeOrthographic = function makeOrthographic (left, right, top, bottom, near, far) {
	...
	Matrix4$1.prototype.equals = function equals (matrix) {
	...
	var Plane = function Plane(normal, constant) {
		if ( normal === void 0 ) normal = new Vector3$1(1, 0, 0);
	...
	var Spherical$1 = function Spherical$$1(radius, phi, theta) {
		if ( radius === void 0 ) radius = 1;
		if ( phi === void 0 ) phi = 0;
		if ( theta === void 0 ) theta = 0;
	...
	Spherical$1.prototype.set = function set (radius, phi, theta) {
	...
	Spherical$1.prototype.copy = function copy (s) {
	...
	Spherical$1.prototype.clone = function clone () {
	...
	Spherical$1.prototype.setFromVector3 = function setFromVector3 (v) {
	...
	Spherical$1.prototype.makeSafe = function makeSafe () {
	...
	var Octant = function Octant(min, max) {
		if ( min === void 0 ) min = new Vector3$1();
		if ( max === void 0 ) max = new Vector3$1();
	...
	Demo.prototype.load = function load (callback) { callback(); };
	...
	FrustumCuller.prototype.configure = function configure (gui) {
		...
		subFolder.add(this.s, "radius").min(0.1).max(10.0).step(0.1).onChange(function () { this$1.cull(); });
		subFolder.add(this.s, "phi").min(1e-6).max(Math.PI - 1e-6).onChange(function () { this$1.cull(); });
		subFolder.add(this.s, "theta").min(0.0).max(Math.PI * 2.0).onChange(function () { this$1.cull(); });
